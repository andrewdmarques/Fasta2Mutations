...
for(i in 1:length(seq_files)){
  ...
  # Open the reference and sample aa files.
  gb <- readGenBank("Wuhan-Hu-1.gb")
  ...
  for(j in 1:length()){
    ...
    for(k in 1:length()){
      ...
      # Record the protein product name. 
      if(mut3$`Genomic Position`[i] >= 266 && mut3$`Genomic Position`[i] < 805){mut3$`Affected Protein`[i] <- "Nsp1"}
      if(mut3$`Genomic Position`[i] >= 806 && mut3$`Genomic Position`[i] < 2719){mut3$`Affected Protein`[i] <- "Nsp2"}
      if(mut3$`Genomic Position`[i] >= 2720 && mut3$`Genomic Position`[i] < 8554){mut3$`Affected Protein`[i] <- "Nsp3"}
      if(mut3$`Genomic Position`[i] >= 8555 && mut3$`Genomic Position`[i] < 10054){mut3$`Affected Protein`[i] <- "Nsp4"}
      if(mut3$`Genomic Position`[i] >= 10055 && mut3$`Genomic Position`[i] < 10972){mut3$`Affected Protein`[i] <- "3CL-PRO"}
      if(mut3$`Genomic Position`[i] >= 10973 && mut3$`Genomic Position`[i] < 11842){mut3$`Affected Protein`[i] <- "Nsp6"}
      if(mut3$`Genomic Position`[i] >= 11843 && mut3$`Genomic Position`[i] < 12091){mut3$`Affected Protein`[i] <- "Nsp7"}
      if(mut3$`Genomic Position`[i] >= 12092 && mut3$`Genomic Position`[i] < 12685){mut3$`Affected Protein`[i] <- "Nsp8"}
      if(mut3$`Genomic Position`[i] >= 12686 && mut3$`Genomic Position`[i] < 13024){mut3$`Affected Protein`[i] <- "Nsp9"}
      if(mut3$`Genomic Position`[i] >= 13025 && mut3$`Genomic Position`[i] < 13441){mut3$`Affected Protein`[i] <- "Nsp10"}
      if(mut3$`Genomic Position`[i] >= 13442 && mut3$`Genomic Position`[i] < 16236){mut3$`Affected Protein`[i] <- "Pol"}
      if(mut3$`Genomic Position`[i] >= 16237 && mut3$`Genomic Position`[i] < 18039){mut3$`Affected Protein`[i] <- "Hel"}
      if(mut3$`Genomic Position`[i] >= 18040 && mut3$`Genomic Position`[i] < 19620){mut3$`Affected Protein`[i] <- "ExoN"}
      if(mut3$`Genomic Position`[i] >= 19621 && mut3$`Genomic Position`[i] < 20658){mut3$`Affected Protein`[i] <- "Nsp15"}
      if(mut3$`Genomic Position`[i] >= 20659 && mut3$`Genomic Position`[i] < 21552){mut3$`Affected Protein`[i] <- "Nsp16"}
      if(mut3$`Genomic Position`[i] >= 21563 && mut3$`Genomic Position`[i] < 25381){mut3$`Affected Protein`[i] <- "Spike"}
      # if(mut3$`Genomic Position`[i] >= 21599 && mut3$`Genomic Position`[i] < 23617){mut3$`Affected Protein`[i] <- "S1"}
      # if(mut3$`Genomic Position`[i] >= 23618 && mut3$`Genomic Position`[i] < 25381){mut3$`Affected Protein`[i] <- "S2"}
      if(mut3$`Genomic Position`[i] >= 25393 && mut3$`Genomic Position`[i] < 26217){mut3$`Affected Protein`[i] <- "ORF3a"}
      if(mut3$`Genomic Position`[i] >= 26245 && mut3$`Genomic Position`[i] < 26469){mut3$`Affected Protein`[i] <- "Envelope"}
      if(mut3$`Genomic Position`[i] >= 26523 && mut3$`Genomic Position`[i] < 27188){mut3$`Affected Protein`[i] <- "Membrane"}
      if(mut3$`Genomic Position`[i] >= 27202 && mut3$`Genomic Position`[i] < 27384){mut3$`Affected Protein`[i] <- "ORF6"}
      if(mut3$`Genomic Position`[i] >= 27439 && mut3$`Genomic Position`[i] < 27756){mut3$`Affected Protein`[i] <- "ORF7a"}
      if(mut3$`Genomic Position`[i] >= 27756 && mut3$`Genomic Position`[i] < 27884){mut3$`Affected Protein`[i] <- "ORF7b"}
      if(mut3$`Genomic Position`[i] >= 27939 && mut3$`Genomic Position`[i] < 28256){mut3$`Affected Protein`[i] <- "ORF8"}
      if(mut3$`Genomic Position`[i] >= 28274 && mut3$`Genomic Position`[i] < 29530){mut3$`Affected Protein`[i] <- "Nucleocapsid"}
      if(mut3$`Genomic Position`[i] >= 29558 && mut3$`Genomic Position`[i] < 29671){mut3$`Affected Protein`[i] <- "ORF10"}
    }
